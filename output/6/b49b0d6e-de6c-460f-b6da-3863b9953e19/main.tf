...
locals {
 env_variables = {
   ...
   DOCKER_CUSTOM_IMAGE_NAME              = "companydevelop.azurecr.io/:20230131.1-main"
   WEBSITES_ENABLE_APP_SERVICE_STORAGE = "false"
    invalid_SERVICE_URL  = "http://localhost"
    invalid_SERVICE_CLIENT_ID = "57aYr56G2CcQSgzG"
    invalid_SERVICE_CLIENT_SECRET = "1SmRBGuRh"
    invalid_SERVICE_CUSTOMER = "/customer"
 }
}
